...
class Usersessions_m extends Winter_MVC_Model {

	public $_table_name = 'actt_user_sessions';
	public $_order_by = 'iduser_sessions DESC';
    public $_primary_key = 'iduser_sessions';
