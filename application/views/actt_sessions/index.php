        ...
        <div class="see-panel-body">
            ...
            <div class="form-inline">
                <div class="footer-btns">
                    <a href="<?php echo admin_url("admin.php?page=actt_sessions&function=export_csv_sessions"); ?>" class="export_csv btn btn-warning pull-right <?php if ( !function_exists('activitytimepro_fms') || !activitytimepro_fms()->is_plan_or_trial('activitytimepropro') ) echo 'actt-pro'; ?>"><i class="fa fa-download"></i>&nbsp;&nbsp;<?php echo __('Export CSV','activitytime')?></a>
...
jQuery(document).ready(function($) {
    ...
    $('[name="filter_user"]').on('change', function(){
        if($(this).val() != '') {
            $('.export_csv').attr('href', '<?php echo get_admin_url() . "admin.php?page=actt_sessions&function=export_csv_sessions"; ?>&filter_user='+$(this).val());
        } else {
            $('.export_csv').attr('href', '<?php echo get_admin_url() . "admin.php?page=actt_sessions&function=export_csv_sessions"; ?>');
        }
    });*/
    ...
    $('#din-table input[type="text"]').on('keyup', function()
    {
        ...
        $('.export_csv').attr('href', '<?php echo get_admin_url() . "admin.php?page=actt_sessions&function=export_csv_sessions"; ?>&'+query_filter);
    });
